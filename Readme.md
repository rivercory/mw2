...
We’re excited to have you contribute to this _Ice Cream Parlour Website_ project! Follow these simple steps to get started:

1. **🍴 Fork the Repository**

   - Go to the [repository page](https://github.com/tushargupta1504/Medical-Website/fork).
   - Click the _Fork_ button (top right). This creates a copy of the project in your GitHub account.
...
8. **🔄 Create a Pull Request (PR)**
   ...
   - Click the _Compare & pull request_ button.
